...
import type { DevelopmentReadinessContext } from "@/lib/developer/developmentReadiness";
import { cn } from "@/lib/utils";

export function DevelopmentReadinessPanel({ context }: { context: DevelopmentReadinessContext }) {
  return (
    <div className="space-y-4 text-sm">
      ...
      <p className="text-[10px] text-muted">Recommendation only—no automatic approval or coding.</p>
    </div>
  );
}
