        ...
        <div className="space-y-6">
          ...
          <Card>
            <div className="mb-4 flex items-start justify-between gap-4">
              <SectionHeader
                title="Mission Delivery Context"
                description="Task distribution, review, repository, and release readiness for this mission"
                className="mb-0"
              />
              <Link
                href={`/delivery-workspace?mission=${missionId}`}
          ...
          <Card>
            <div className="mb-4 flex items-start justify-between gap-4">
              <SectionHeader
                title="Release Readiness Context"
                description="Checklist, risks, and readiness summary for this mission"
                className="mb-0"
              />
              <Link
                href={`/release-workspace?mission=${missionId}`}
                className="shrink-0 text-xs text-accent hover:underline"
              >
