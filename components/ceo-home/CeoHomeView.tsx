    ...
    >
      <div className="space-y-8">
        ...
        <Card
          ...
          description="Implementation plans, development reviews, technical risks, and QA planning candidates"
          action={
            <Link href="/developer-workspace" className="text-xs text-accent hover:underline">
