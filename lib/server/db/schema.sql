...
CREATE TABLE IF NOT EXISTS feed_items (
  ...
  metadata_json TEXT,
  decision_attention_id TEXT,
  decision_attention_severity TEXT,
  decision_attention_category TEXT,
  decision_attention_reason TEXT,
  decision_attention_source TEXT,
  decision_attention_replay_confidence TEXT,
  decision_attention_continuity_category TEXT,
  decision_attention_lifecycle TEXT,
  created_at TEXT NOT NULL,
  FOREIGN KEY (mission_id) REFERENCES missions (id) ON DELETE CASCADE,
