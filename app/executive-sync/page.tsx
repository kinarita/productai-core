...
import { executiveSyncContext } from "@/data/mockData";
import { Gavel } from "lucide-react";

export default function ExecutiveSyncPage() {
  const ctx = executiveSyncContext;
    ...
    >
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="space-y-6 lg:col-span-2">
          <Card title={ctx.topic} description={`Mission: ${ctx.mission}`}>
